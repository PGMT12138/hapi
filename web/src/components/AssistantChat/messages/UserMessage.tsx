...
export function HappyUserMessage() {
    ...
    const userBubbleClass = `inline-block text-left max-w-[92%] align-top rounded-xl bg-[var(--app-chat-user-surface-bg)] border border-[var(--app-user-bubble-border)] px-3 py-2 text-[var(--app-fg)] shadow-sm`
