export default {
  ...
  'spawn.plugins.empty': '该项目下未找到 plugins',
  'spawn.plugins.hint': '配置写入 .claude/settings.local.json',
  'spawn.plugins.useGlobal': '使用全局配置',
  'spawn.plugins.useGlobalHint': '关闭后可单独管理项目级 plugin',
  ...
  'composer.schedulePreset.5m': '+5 分钟',
  'composer.schedulePreset.30m': '+30 分钟',
  'composer.schedulePreset.1h': '+1 小时',
  'composer.schedulePreset.4h': '+4 小时',
  'composer.scheduleSpecificHint': '最多可安排 7 天内',
  'composer.scheduleConfirm': '确认',
  'composer.scheduleErrorPast': '时间已过',
  'composer.scheduleErrorTooFar': '必须在 7 天以内',
  'queued.label': '队列中',
  'queued.cancel': '取消',
