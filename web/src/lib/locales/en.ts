export default {
  ...
  'spawn.plugins.title': 'Plugins',
  'spawn.plugins.empty': 'No plugins found for this project',
  'spawn.plugins.hint': 'Stored in .claude/settings.local.json',
  'spawn.plugins.useGlobal': 'Use global config',
  'spawn.plugins.useGlobalHint': 'Turn off to manage project-level plugins individually',
  ...
  'composer.scheduleSpecificTab': 'Specific time',
  'composer.schedulePreset.5m': '+5 min',
  'composer.schedulePreset.30m': '+30 min',
  'composer.schedulePreset.1h': '+1 hour',
  'composer.schedulePreset.4h': '+4 hours',
  'composer.scheduleSpecificHint': 'Up to 7 days from now',
  'composer.scheduleConfirm': 'Confirm',
  'composer.scheduleErrorPast': 'Time is in the past',
  'composer.scheduleErrorTooFar': 'Must be within 7 days',
  'queued.label': 'Queued',
  ...
  'extensions.selectMachine': 'Select machine',
  ...
  'extensions.detail.path': 'Path',
  'extensions.detail.files': 'Files',
  'extensions.detail.content': 'Content',
