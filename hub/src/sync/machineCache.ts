...
export class MachineCache {
    ...
    refreshMachine(machineId: string): Machine | null {
        ...
        const metadata = (() => {
            ...
            return { host, platform, happyCliVersion, displayName, homeDir, happyHomeDir, happyLibDir, workspaceRoot, workspaceRoots: workspaceRoots.length > 0 ? workspaceRoots : undefined }
        })()
